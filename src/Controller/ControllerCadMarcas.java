		...
		case "Marca":
			if (!tela.getMarcasNomeField().getText().isEmpty()) {
				...
				if (!marcaNomeInvalido) {
					...
					JOptionPane.showMessageDialog(null, "Marca j� est� registrada!");
				}
		...
		case "Modelo":
			...
			&& tela.getModelosMarcaCBox().getSelectedItem() != tela.getModelosMarcaCBox().getItemAt(0)) {
				...
				if (!modeloNomeInvalido) {
					...
					JOptionPane.showMessageDialog(null, "Modelo j� est� registrado dentro dessa marca!");
				}
			} else {
				JOptionPane.showMessageDialog(null, "H� campos em branco/n�o selecionados!");
			}
		...
		case "Versao":
			...
			&& !tela.getVersoesClasseCBox().getSelectedItem().equals(tela.getVersoesClasseCBox().getItemAt(0))){
				...
				if (!versaoNomeInvalido) {
					...
					JOptionPane.showMessageDialog(null, "Essa versao j� est� registrada dentro desse modelo!");
				} 
				break;
			} else {
				JOptionPane.showMessageDialog(null, "H� campos em branco/n�o selecionados!");
